...
<title>All Religion and Spirituality books</title>
</head>
<body>
...
<div class="container text-center">
    <div class="row">
        ...
        List<Book_details> RSBooks = dao.displayNewRnSBook();
        for (Book_details book : RSBooks) {
        %>
        <div class="col-md-3">
            <div class="card crd-ho">
                <div class="card-body text-center">
                    <img alt="Book Image" src="Ebook-App/book images/<%=  book.getBkphotoName() %>"
