...
<div class= "" style="background-color:#ade0ee; font-size: 30px;" >
  ...
  <div class="card-body border-3">
    <h5 class="card-title"><i class="fa-solid fa-book-medical fa-3x"></i></h5>
    <a href="add_a_book.jsp" class="btn btn-success">Add Book</a>
  </div>
</div></div>
    
    <div class="col"><div class="card" style="width: 18rem;">
  <div class="card-body border-3">
    <h5 class="card-title"><i class="fa-solid fa-book fa-3x"></i></h5>
    <a href="books.jsp" class="btn btn-success">All books</a>
  </div>
</div></div>
